<template>
    <div class="grid grid-cols-1 gap-3 rounded-xl border p-3 sm:grid-cols-2 sm:p-4" id="batch-phone-check">
        <!-- 顶部按钮：下载示例 -->
...
async function processFile(file: File) {
    ...
    uploadFile<ApiResponse>('/mobile-locator/upload', {}, 'file', file).then((data) => {
        if (data.code == 0) {
