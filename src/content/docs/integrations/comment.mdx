...
2. Remove folder `src/components/waline`.

3. Remove relative code in these layouts:

   - `src/layouts/CommonPage.astro`
   - `src/layouts/BlogPost.astro`

4. Remove relative config like `comment` or `view` configuring for the earlier edited layouts in these files:
