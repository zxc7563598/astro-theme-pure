...
- Change the UnoCSS preset from `Wind3` to `Mini`. Some features are removed, like `gradient`, `animation`, `container`, etc.

### v4.0.3

- Change footer registration config to `links`. This will give you more flexibility to add more links or other information:
...
A soluble way for Windows user is using tool [WinMerge](https://winmerge.org/).
