---
title: '私有网络与服务端通信配置记录'
publishDate: '2025-06-13 16:52:45'
description: '本文为作者个人的网络服务配置笔记，仅供自用。内容涉及敏感配置，公开可能引发风险。如确有学习需求，请联系作者获取访问权限'
tags:
  - Web
language: '中文'
...
slug: 'hqnd9ut2'
password: 
  - { question: '访问密码是什么', answer: '7563598' }
---

> 背景介绍：
>
> 在国内直接访问境外网站常受限制，原因在于国内对境外流量进行了严格控制。  
> 但有一个特点：**国内到港澳台之间是互通的**。  
> 也就是说，你可以买一台最便宜的香港服务器作为“中转”，因为：
>
> - 国内 -\> 香港之间速度极快，延迟极低。
> - 香港 -\> 境外的连接没有封锁。
>
> 比如，阿里云香港机器，**1 元 / 1GB** 流量，完全够用，性价比极高，且不限速。  
> 用 Shadowsocks 做一层简单转发，配合 Clash 客户端，完全可以跑满带宽。
>
> 简而言之：  
> 用一台香港服务器当“跳板”，国内到香港不限速，香港再帮你访问境外。
>
> 接下来是完整配置步骤。

---

## 一、 在服务器上安装 Shadowsocks 服务端
...
> - ​`server_port`​: 修改为你需要的端口。
> - ​`password`​: 修改为自己的密码。
> - ​`method`​: 可选 `chacha20-ietf-poly1305`​、`aes-256-gcm`​ 等。
> - ​`mode`​: 通常为 `tcp_and_udp`​，使 UDP 可用。
...
Windows 客户端：[Clash for Windows](https://www.clashforwindows.net)  

iOS 客户端：[Shadowrocket](https://apps.apple.com/us/app/shadowrocket/id932747118)

Android 客户端：[Clash for Android](https://clashforandroid.org/clash-for-android-download)

Mac 客户端：[Clash Verge](https://clashverge.net)
